# noOPV.mod
# exclude OPV vaccine and combine IPV and OPV antigens

# ----- SETS ------------------ ** ordered = same spot otherwise need change
set VACCINES ordered;   # vaccines: 1 DTP 2 HepB 3 IPV 4 Pent 5 Hex 6 DTaP-IPV 7 DTwP-HepB
...
#     sum{i in MFRS}(quant[member(4, VACCINES),i,t]) <= (demand[member(5, ANTIGENS),t]); 
