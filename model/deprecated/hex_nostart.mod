...
var quant{v in VACCINES, i in MFRS, t in HORIZON} >= 0;  # quantity

var y{i in MFRS} binary;  # whether mfr i should produce the hexavalent vaccine
var z >= 0;  # bound on price difference

var x{v in VACCINES, i in MFRS, t in HORIZON} binary;     # if vaccine v is produced in year t
